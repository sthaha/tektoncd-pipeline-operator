...
func (in *AddonsCondition) DeepCopyInto(out *AddonsCondition) {
	*out = *in
	if in.Resources != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AddonsCondition.
func (in *AddonsCondition) DeepCopy() *AddonsCondition {
	if in == nil {
		return nil
	}
	out := new(AddonsCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ConfigStatus) DeepCopyInto(out *ConfigStatus) {
	*out = *in
	...
	if in.Addons != nil {
		in, out := &in.Addons, &out.Addons
		*out = make([]AddonsCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
